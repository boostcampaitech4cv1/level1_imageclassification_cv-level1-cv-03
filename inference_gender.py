...
def load_model(saved_model, num_classes, device):
    model_cls = getattr(import_module("model_gender"), args.model)
    model = model_cls(
...
def inference(data_dir, model_dir, output_dir, args):
    ...
    info['ans'] = preds
    save_path = os.path.join(output_dir, f'output_gender.csv')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', type=str, default=os.environ.get('SM_CHANNEL_MODEL', './model/exp_gender19'))
