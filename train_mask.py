...
from dataset_mask import CustomDataset
...
def train(data_dir, model_dir, args):
    ...
    # -- dataset
    dataset_module = getattr(import_module("dataset_mask"), 'MaskBaseDataset')
    ...
    # -- model
    model_module = getattr(import_module("model_mask"), args.model)
    model = model_module(
