...
def train(data_dir, model_dir, args):
    ...
    # -- dataset
    dataset_module = getattr(import_module("dataset_age"), args.dataset)  # default: MaskBaseDataset
    ...
    # -- augmentation
    train_transform_module = getattr(import_module("dataset_age"), args.augmentation)  # default: BaseAugmentation
    transform_train = train_transform_module(
        resize=args.resize,
        mean=dataset.mean,
        std=dataset.std,
    )
    val_transform_module = getattr(import_module("dataset_age"), 'BaseAugmentation')  # default: BaseAugmentation
    ...
    # -- model
    model_module = getattr(import_module("model_age"), args.model)  # default: BaseModel
    model = model_module(
